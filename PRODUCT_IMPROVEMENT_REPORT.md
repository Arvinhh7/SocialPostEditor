...
> 状态说明：本文是实施前的缺点分析与来源溯源，保留用于解释设计依据。其中评测、运行步骤、人工审批、反馈准入、批量投喂、角色任务默认值、审批摘要、批量纠错、检索负反馈、反馈批量决策和角色克隆已在当前本地工作区落地；最新实现状态与 GitHub 旧版对比请以 `CHANGE_COMPARISON_REPORT.md` 为准。
